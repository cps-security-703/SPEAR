...
STRIDE_MITRE_RL_MAPPING_QUERIES = [
    ...
    },
    {
        ...
        "ground_truth": {
            "stride": ["Tampering"],
            "mitre_techniques": ["T0871", "T0836", "T0831"],
    ...
    },
    {
        ...
        "ground_truth": {
            ...
            "mitre_techniques": ["T0840", "T0802", "T0888", "T0842"],
    ...
    },
    {
        ...
        "ground_truth": {
            ...
            "mitre_techniques": ["T0816", "T0814", "T0800", "T0831"],
    ...
    },
    {
        ...
        "ground_truth": {
            "stride": ["Repudiation"],
            "mitre_techniques": ["T0872", "T0858", "T0820"],
    ...
    },
    {
        ...
        "ground_truth": {
            ...
            "mitre_techniques": ["T0890", "T0891", "T0839"],
    ...
    },
    {
        ...
        "ground_truth": {
            "stride": ["Tampering"],
            "mitre_techniques": ["T0836", "T0831", "T0855"],
            "projected_rl_action": "Data injection",
            "protocols": ["OCPP"],
            "affected_systems": ["EV", "EVCS"],
            "expected_cves": ["CVE-2022-3203", "CVE-2022-3204"]
    ...
    },
    {
        ...
        "ground_truth": {
            "stride": ["Denial of Service"],
            "mitre_techniques": ["T0816", "T0814", "T0831"],
            "projected_rl_action": "Power disruption",
            "protocols": ["OCPP", "HTTPS"],
            "affected_systems": ["EVCS", "CMS", "CCMS"],
            "expected_cves": []
    ...
    },
    {
        ...
        "ground_truth": {
            "stride": ["Spoofing"],
            "mitre_techniques": ["T0855", "T0866", "T0868"],
            "projected_rl_action": "Communication spoofing",
            "protocols": ["DNP3"],
    ...
    },
    {
        ...
        "ground_truth": {
            "stride": ["Information Disclosure"],
            "mitre_techniques": ["T0842", "T0840", "T0868"],
            "projected_rl_action": "Voltage manipulation",
            "protocols": ["OCPP"],
            "affected_systems": ["EV", "EVCS"],
            "expected_cves": []
    ...
    },
    {
        ...
        "ground_truth": {
            "stride": ["Elevation of Privilege"],
            "mitre_techniques": ["T0890", "T0891", "T0871"],
            "projected_rl_action": "Current injection",
            "protocols": ["OCPP", "HTTPS"],
            "affected_systems": ["EVCS", "CMS", "EV"],
            "expected_cves": ["CVE-2023-2891"]
        }
    },
    {
        ...
        "ground_truth": {
            "stride": ["Tampering"],
            "mitre_techniques": ["T0836", "T0831", "T0871"],
            "projected_rl_action": "Data injection",
            "protocols": ["DNP3"],
    ...
    },
    {
        ...
        "ground_truth": {
            "stride": ["Denial of Service"],
            "mitre_techniques": ["T0816", "T0814", "T0800"],
            "projected_rl_action": "Power disruption",
            "protocols": ["TCP/IP", "Modbus TCP"],
            "affected_systems": ["EMS", "AGC", "SCADA"],
