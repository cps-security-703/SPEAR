...
class EvaluationMetrics:
    """
    Metrics for evaluating RAG vs non-RAG responses
    """
    
    @staticmethod
    def extract_mitre_techniques(text: str) -> Set[str]:
        """Extract MITRE technique IDs from text (e.g., T0866, T0814)"""
        pattern = r'T\d{4}'
    ...
    def extract_cve_ids(text: str) -> Set[str]:
        """Extract CVE IDs from text (e.g., CVE-2024-1234)"""
    ...
    def calculate_specificity_score(text: str) -> Dict[str, any]:
        """
        Calculate specificity score based on presence of technical terms
        """
        # Technical terms that indicate specific, actionable information
        technical_terms = [
    ...
    def calculate_completeness_score(text: str, expected_sections: List[str]) -> Dict[str, any]:
        """
        Calculate completeness based on presence of expected sections
        """
        text_lower = text.lower()
        found_sections = {}
    ...
    def calculate_actionability_score(text: str) -> Dict[str, any]:
        """
        Calculate actionability based on presence of actionable recommendations
        """
        actionable_keywords = [
    ...
    def validate_against_ground_truth(rag_response: str, non_rag_response: str, 
        ...
        """
        Validate responses against ground truth data
        """
        validation = {}
        
        # Check if expected MITRE techniques are mentioned
        ...
        # Check if expected STRIDE categories are mentioned
