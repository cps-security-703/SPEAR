"""
Example usage of the ARES RAG system
"""
...
def example_1_vulnerability_analysis():
    """Example 1: Analyze vulnerabilities in an EVSE system"""
    print("\n" + "=" * 80)
...
def example_2_rl_attack_strategies():
    """Example 2: Generate RL attack strategies"""
    print("\n" + "=" * 80)
...
def example_3_direct_database_query():
    """Example 3: Query the vector database directly"""
    print("\n" + "=" * 80)
...
def example_4_interactive_qa():
    """Example 4: Interactive Q&A with RAG"""
    print("\n" + "=" * 80)
...
def main():
    ...
    try:
        ...
        # Note: Examples 1, 2, and 4 require Gemini API key
